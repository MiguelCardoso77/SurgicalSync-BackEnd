# UC25 - Update an operation request
...
As a Doctor, I want to update an operation requisition, so that the Patient has
...
possess the capability to update an operation requisition.
...
are identified. This includes the API functionalities necessary for the update of an operation´s requisition.
...
This use case is estimated to necessitate an allocation of approximately 6 to 12 hours (M Size) for completion.
