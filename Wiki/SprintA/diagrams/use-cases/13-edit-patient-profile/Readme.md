...
The client has outlined that the Admin Role should possess the functionality to edit patient profiles.
...
possess the ability to edit patient profiles, designating their respective roles and
