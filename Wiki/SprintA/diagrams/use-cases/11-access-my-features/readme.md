...
As a Patient, I want to access my appointments, medical records, and other features securely.
...
possess the capability to access his appointments, medical records, and other features securely.
...
are identified. This includes the API functionalities necessary for the visualization of patient´s appointments, medical records and other features. 
