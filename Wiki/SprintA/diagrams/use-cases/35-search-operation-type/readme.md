# Search For Operation Types

## 1. Use Case Description

As an Admin, I want to search for an operation type.

## 2. Customer Specifications and Clarifications

The client has outlined that the Admin Role should possess the functionality to search for an operation type.
