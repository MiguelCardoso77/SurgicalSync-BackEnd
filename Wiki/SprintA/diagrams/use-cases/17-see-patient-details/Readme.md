...
As an Admin, I want to see patient details

## 2. Customer Specifications and Clarifications

The client has outlined that the Admin Role should possess the functionality to see patient details.

The patient's medical record number must be unique.
...
- A unique patient ID (Medical Record Number) 
- 
## 5. Dependencies
...
possess the ability to see patient profile.
...
are identified. This includes the API functionalities necessary for seeing patient profile.
