...
possess the capability to delete his account and all the associated data, exercising his right to be forgotten as per GDPR legislation.
...
are identified. This includes the API functionalities necessary for the deletion of Patient accounts and all their data.
