...
namespace DDDNetCore.Application.Mappers
{
    public class PatientMapper
    {
        ...
        {
            return new Patient(new PatientName(dto.PatientName), new BirthDate(dto.BirthDate),
                new Gender(dto.Gender), medicalRecordNumber,
                new PhoneNumber(dto.PhoneNumber),
                medicalConditions, new EmergencyContact(dto.EmergencyContact), appointmentHistory);
        }
    }
}
